...
// PG_GOVERNOR_CONFIG
    ...
    { "gov_vbat_offset",            VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 50000 }, PG_GOVERNOR_CONFIG, offsetof(governorConfig_t, gov_vbat_offset) },
    ...
    { "gov_ff_filter",              VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 1, 10000 }, PG_GOVERNOR_CONFIG, offsetof(governorConfig_t, gov_ff_filter) },
    { "gov_cc_filter",              VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 1, 10000 }, PG_GOVERNOR_CONFIG, offsetof(governorConfig_t, gov_cc_filter) },
