...
#define MIXER_MOTOR_OFFSET    MAX_SUPPORTED_SERVOS
...
static inline bool mixerPidAxisSaturated(uint8_t i) { return mixerInputSaturated(MIXER_IN_STABILIZED_ROLL + i); }

static inline void mixerSaturateServoOutput(uint8_t i) { mixerSaturateOutput(MIXER_SERVO_OFFSET + i); }
static inline void mixerSaturateMotorOutput(uint8_t i) { mixerSaturateOutput(MIXER_MOTOR_OFFSET + i); }
