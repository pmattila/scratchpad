...
void pidInitConfig(const pidProfile_t *pidProfile)
{
    ...
    pidCoefficient[FD_ROLL].Kf = ROLL_FEEDFWD_SCALE * pidProfile->pid[FD_ROLL].F;
    ...
    pidCoefficient[FD_PITCH].Kf = PITCH_FEEDFWD_SCALE * pidProfile->pid[FD_PITCH].F;
    ...
    pidCoefficient[FD_YAW].Kf = YAW_FEEDFWD_SCALE * pidProfile->pid[FD_YAW].F;
