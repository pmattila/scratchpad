...
#ifdef USE_SERVOS
    blackboxCurrent->servo[0] = getServoOutput(0);
    blackboxCurrent->servo[1] = getServoOutput(1);
    blackboxCurrent->servo[2] = getServoOutput(2);
    blackboxCurrent->servo[3] = getServoOutput(3);
#endif
